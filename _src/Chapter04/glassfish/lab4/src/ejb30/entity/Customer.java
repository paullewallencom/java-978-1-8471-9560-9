...
public class Customer implements Serializable {
    ...
    @OneToMany(mappedBy="customer", fetch=EAGER, cascade=REMOVE) 
    ...
    @JoinTable(
        ...
        joinColumns={
         @JoinColumn(name="CUST_FNAME", referencedColumnName="FIRST_NAME"),  
         @JoinColumn(name="CUST_LNAME", referencedColumnName="LAST_NAME") },  
